...
SPECS_BY_CATEGORY = {
    ...
    "display driver": [("voltage", "V"), ("current", "A")],
    "comparator": [("voltage", "V")],
    "timer": [("voltage", "V"), ("frequency", "Hz")],
    "logic": [("voltage", "V")],
    "interface": [("voltage", "V")],
    "analog switch": [("voltage", "V"), ("current", "A")],
    "audio amplifier": [("voltage", "V"), ("current", "A")],
    "rtc": [("voltage", "V"), ("frequency", "Hz")],
    "fpga": [("voltage", "V"), ("frequency", "Hz")],
    "rf": [("voltage", "V"), ("frequency", "Hz")],
    "potentiometer": [("resistance", "Ω"), ("wattage", "W"), ("tolerance", "%")],
    "transformer": [("voltage", "V"), ("current", "A")],
    "varistor": [("voltage", "V"), ("current", "A")],
    "thyristor": [("voltage", "V"), ("current", "A")],
    "relay": [("voltage", "V"), ("current", "A")],
    "battery": [("voltage", "V"), ("current", "A")],
    "buzzer": [("voltage", "V"), ("frequency", "Hz")],
    "motor": [("voltage", "V"), ("current", "A")],
    "display": [("voltage", "V")],
    "module": [("voltage", "V"), ("current", "A")],
    "connector": [("voltage", "V"), ("current", "A")],
    "switch": [("voltage", "V"), ("current", "A")],
